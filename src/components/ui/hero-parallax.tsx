...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[200vh] sm:h-[250vh] overflow-hidden antialiased relative flex flex-col self-auto [perspective:600px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold dark:text-white">
       Learnix, <br />Ultimate learning platform
      </h1>
